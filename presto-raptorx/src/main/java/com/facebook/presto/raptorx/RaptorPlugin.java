        ...
        implements Plugin
{
    ...
    {
        this(info.getName(), info.getDatabaseModule(), info.getBackupProviders());
    }

    public RaptorPlugin(String name, Module databaseModule, Map<String, Module> backupProviders)
    {
    ...
    {
        return ImmutableList.of(new RaptorConnectorFactory(name, databaseModule, backupProviders));
    }
