...
public class ChunkRecoveryStats
{
    ...
    private final CounterStat chunkRecoveryBackupNotFound = new CounterStat();
    ...
    public void incrementChunkRecoveryBackupNotFound()
    {
        chunkRecoveryBackupNotFound.update(1);
    }
    ...
    @Managed
    @Nested
    public CounterStat getChunkRecoveryBackupNotFound()
    {
        return chunkRecoveryBackupNotFound;
    }
