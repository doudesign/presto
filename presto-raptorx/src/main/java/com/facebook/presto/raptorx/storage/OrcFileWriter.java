...
import com.facebook.presto.raptorx.util.SyncingFileSystem;
...
import static com.facebook.presto.raptorx.storage.Row.extractRow;
import static com.facebook.presto.raptorx.storage.StorageType.arrayOf;
import static com.facebook.presto.raptorx.storage.StorageType.mapOf;
        ...
        implements Closeable
{
    ...
    OrcFileWriter(List<Long> columnIds, List<Type> columnTypes, File target, boolean writeMetadata)
    {
        ...
        Iterable<String> hiveTypeNames = storageTypes.stream().map(StorageType::getHiveType).collect(toList());
