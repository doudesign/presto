...
{
    public static final RaptorColumnHandle CHUNK_ROW_ID_HANDLE = new RaptorColumnHandle(-1, "$chunk_row_id", BIGINT);
    public static final RaptorColumnHandle CHUNK_ID_HANDLE = new RaptorColumnHandle(-2, "$chunk_id", BIGINT);
    public static final RaptorColumnHandle BUCKET_NUMBER_HANDLE = new RaptorColumnHandle(-3, "$bucket_number", INTEGER);
    ...
    public boolean isChunkRowId()
    {
        return isChunkRowIdColumn(columnId);
    }

    public boolean isChunkId()
    {
        return isChunkIdColumn(columnId);
    }
