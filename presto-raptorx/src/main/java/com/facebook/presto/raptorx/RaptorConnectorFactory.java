...
import com.facebook.presto.raptorx.backup.BackupModule;
        ...
        implements ConnectorFactory
{
    ...
    public RaptorConnectorFactory(String name, Module databaseModule, Map<String, Module> backupProviders)
    {
