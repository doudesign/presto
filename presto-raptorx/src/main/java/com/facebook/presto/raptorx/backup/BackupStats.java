...
public class BackupStats
{
    ...
    private final DistributionStat copyToBackupChunkSizeBytes = new DistributionStat();
    ...
    public void addCopyChunkDataRate(DataSize size, Duration duration)
    {
        ...
        copyToBackupChunkSizeBytes.add(size.toBytes());
    ...
    @Managed
    @Nested
    public DistributionStat getCopyToBackupChunkSizeBytes()
    {
        return copyToBackupChunkSizeBytes;
    }
