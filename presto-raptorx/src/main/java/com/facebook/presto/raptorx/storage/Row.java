...
public class Row
{
    ...
    {
        checkArgument(page.getChannelCount() == types.size(), "channelCount does not match types");
        checkElementIndex(position, page.getPositionCount());
        ...
        verify(row.getColumns().size() == types.size());
        return row;
    }
