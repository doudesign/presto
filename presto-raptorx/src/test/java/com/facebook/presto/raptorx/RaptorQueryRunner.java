...
public final class RaptorQueryRunner
{
    ...
    public static DistributedQueryRunner createRaptorQueryRunner(Map<String, String> extraProperties, boolean loadTpch, boolean bucketed)
            throws Exception
    {
        DistributedQueryRunner queryRunner = new DistributedQueryRunner(createSession("tpch"), 0, extraProperties);
...
//        sessionPropertyManager.addConnectorSessionProperties(new ConnectorId("raptorx"), new RaptorSessionProperties(new StorageManagerConfig()).getSessionProperties());
