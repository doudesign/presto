...
public abstract class AbstractTestBackupStore<T extends BackupStore>
{
            ...
            throws Exception
    {
        ...
        // delete random UUID
        store.deleteChunk(nextChunkId.getAndIncrement());
    }
}
