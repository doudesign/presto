...
public class TestPrestoDriverUri
{
    ...
    public void testInvalidUrls()
    {
        ...
        // invalid ssl flag
        assertInvalid("jdbc:presto://localhost:8080?SSL=0", "Connection property 'SSL' value must be 'true' or 'false'");
        assertInvalid("jdbc:presto://localhost:8080?SSL=1", "Connection property 'SSL' value must be 'true' or 'false'");
        assertInvalid("jdbc:presto://localhost:8080?SSL=2", "Connection property 'SSL' value must be 'true' or 'false'");
        assertInvalid("jdbc:presto://localhost:8080?SSL=abc", "Connection property 'SSL' value must be 'true' or 'false'");
